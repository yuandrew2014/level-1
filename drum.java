...
public class drum extends MouseAdapter {
	...
	private void getGoing() throws MalformedURLException {
		...
		String welcome = "can-stock-photo_csp11056968.jpg";
		// 9. Edit the next line to use your String variable
		// drumLabelWithImage = createLabelImage(drumImageString);
		drumLabelWithImage = createLabelImage(welcome);
	...
	public void mouseClicked(MouseEvent e) {
		...
		playSound("252451__scydan__trap-beat-130bpm.wav");
	...
	private void playSound(String ha) {
		AudioClip sound = JApplet.newAudioClip(getClass().getResource(ha));
		sound.play();
	}
